...
export const metadata: Metadata = {
  title: "Photos | Parth Marfatia",
  metadataBase: new URL("https://parthmarfatia.com/photos"),
  description: "Explore photos taken by Parth Marfatia",
  openGraph: {
    title: "Photos | Parth Marfatia",
    url: "https://parthmarfatia.com/photos",
    description: "Explore photos taken by Parth Marfatia",
    images:
